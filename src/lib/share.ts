/**
 * Tạo ảnh chia sẻ 1080x1080 với khung vàng + AI comment + logo YOLO
 * Tương đương: generateShareImage.ts cũ — đã move vào services/
 */
export async function generateShareImage(
  ...
  // Photo centered (780x780 with rounded clip)
  const img = new Image();
